...
class AutoProduceConsume extends Component {
  ...
  handleConsumeSwitchChange = isCheckedConsume => this.setState({ isCheckedConsume: false });

  handleConsumeRateChange = consumeRate => this.setState({ consumeRate });

  handleProduceSwitchChange = isCheckedProduce => this.setState({ isCheckedProduce: false });
